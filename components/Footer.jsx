            ...
            <div className="grid grid-flow-row  grid-cols-1 md:grid-cols-2 gap-2 md:gap-5">
                <div>
                    ...
                    <p className="break-words text-base" >
                        Ho creato questo sito per parlare di ciò che ho fatto a scuola e dei miei progetti personali <br />
                ...
                <div>
                    <p className="text-2xl" >Referenze</p>
                        <ul className="text-base pointer">
                            <li className="mb-1">
                                <a href="https://github.com/mattiaferrari02" target="blank"><div className="inline-block align-bottom">
                                        <FaGithub size="28px"/>
                                    </div>
                            ...
                            <li className="mb-1">
                                    ...
                                    <div className=" pl-1 inline-block align-baseline	">
                                        <CopyToClipboard
                                            text={"mattia.ferrari@soluzionifutura.it"}
                                            onCopy={()=>{
                                                addToast('Email Copiata', { appearance: 'success' });
                                            }}
                                        >
                                            <p className="break-all"> mattia.ferrari@soluzionifutura.it</p>
                                        </CopyToClipboard>
                                    </div>
