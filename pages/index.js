  ...
  return(
    ...
    <div className='bg-gray-900'>
      <main className="landing grid grid-cols-1">
        ...
        <div className="typewriter text-2xl md:text-3xl lg:text-5xl text-gray-300 mx-auto text-center w-screen md:w-1/3 lg:w-1/2 ">
          <Typewriter
            options={{
        ...
        <div className="mx-auto text-center w-screen md:w-1/3 lg:w-1/2 ">
          <Link href='/home'>
              <div className="wrapper">
                <div className="cta bg-gray-700">
                  <span className="next bellogo">AVANTI</span>
                  <span className="bellogo">
